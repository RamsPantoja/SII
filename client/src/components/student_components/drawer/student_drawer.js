            ...
            <div className='drawer-container'>
                <nav>
                    <ul className='link-list'>
                        <li><NavLink activeStyle={{color:'#000000', background:'#4f9a94'}} className='link-to-section' to={`${url}/docs`}><i className='material-icons md-24'>text_snippet</i><div className='topic-container'>Recursos Didacticos</div></NavLink></li>
                        ...
                        <li><NavLink activeStyle={{color:'#000000', background:'#4f9a94'}} className='link-to-section' to={`${url}/school_schedule`}><i className='material-icons md-24'>table_chart</i><div className='topic-container'>Horario Escolar</div></NavLink></li>
                    </ul>
                </nav>
            </div>
        </div>
